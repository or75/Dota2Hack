...
{
	DOTA_HUD_VISIBILITY_INVALID = 4294967295,
...
{
	DOTA_PORTRAIT_ENVIRONMENT_INVALID = 4294967295,
...
enum class DOTA_HOLDOUT_WALL_TYPE : uint32_t
{
...
{
	DOTA_SHOP_CATEGORY_NONE = 4294967295,
...
enum class DotaCustomUIType_t : uint32_t
{
	...
	DOTA_CUSTOM_UI_TYPE_INVALID = 4294967295,
};

enum class DotaDefaultUIElement_t : uint32_t
{
	DOTA_DEFAULT_UI_INVALID = 4294967295,
...
enum class PlayerUltimateStateOrTime_t : uint32_t
{
	...
	PLAYER_ULTIMATE_STATE_NO_MANA = 4294967295,
	PLAYER_ULTIMATE_STATE_NOT_LEVELED = 4294967294,
	PLAYER_ULTIMATE_STATE_HIDDEN = 4294967293,
};
...
{
	PORTRAIT_DISPLAY_MODE_INVALID = 4294967295,
...
{
	PORTRAIT_SOUND_MODE_INVALID = 4294967295,
...
enum class RMSG_EventType_t : uint32_t
{
	RMSG_EVENT_INVALID = 4294967295,
...
enum class RMSG_SubEventType_t : uint32_t
{
	RMSG_SUB_EVENT_INVALID = 4294967295,
...
{
	RENDER_MULTISAMPLE_INVALID = 4294967295,
...
{
	RENDER_SLOT_INVALID = 4294967295,
...
enum class SchemaClassFlags_t : uint32_t
{
...
{
	kEconItemOrigin_Invalid = 4294967295,
...
{
	LITERAL_HAND_TYPE_UNKNOWN = 4294967295,
...
{
	LOGICAL_HAND_TYPE_UNKNOWN = 4294967295,
...
enum class gamerules_roundstate_t : uint32_t
{
	GR_STATE_INIT = 0,
	GR_STATE_PREGAME = 1,
