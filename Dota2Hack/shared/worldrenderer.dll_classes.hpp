...
public:
char CScriptComponent_030[0x28];
...
public:
	__declspec(align(8)) UnknownType <0x8, class CUtlSymbolLarge> m_iszPrivateVScripts;// 0x8, size 8 (0x8)
	// m_iszPrivateVScripts metadata
	 // MNetworkDisable
	__declspec(align(8)) CEntityIdentity *m_pEntity;// 0x10, size 8 (0x8)
	// m_pEntity metadata
	 // MNetworkEnable
	 // MNetworkPriority
char CEntityInstance_020[0x8];
	__declspec(align(4)) UnknownType <0x4, class CUtlStringToken> m_worldGroupId;// 0x20, size 4 (0x4)
	// m_worldGroupId metadata
	 // MNetworkDisable
char CEntityInstance_030[0xC];
	__declspec(align(8)) CScriptComponent *m_CScriptComponent;// 0x30, size 8 (0x8)
